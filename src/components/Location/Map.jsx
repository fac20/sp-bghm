    ...
    <Svg>
      <g>
        ...
        <path
          ...
          id="walthamforest"
          className={
            clicked && "walthamforest" === userLocation ? "clicked" : null
          }
          onClick={locateUser}
        ...
        <path
          ...
          className={
            clicked && "kingstonuponthames" === userLocation ? "clicked" : null
          }
          onClick={locateUser}
        ...
        <path
          ...
          className={
            clicked && "barkinganddagenham" === userLocation ? "clicked" : null
          }
          onClick={locateUser}
        ...
        <path
          ...
          id="towerhamlets"
          className={
            clicked && "towerhamlets" === userLocation ? "clicked" : null
          }
          onClick={locateUser}
        ...
        <path
          ...
          id="wandsworth"
          className={
            clicked && "wandsworth" === userLocation ? "clicked" : null
          }
          onClick={locateUser}
        ...
        <path
          ...
          id="westminster"
          className={
            clicked && "westminster" === userLocation ? "clicked" : null
          }
          onClick={locateUser}
        ...
        <path
          ...
          className={
            clicked && "kensingtonandchelsea" === userLocation
              ? "clicked"
              : null
          }
          onClick={locateUser}
        ...
        <path
          ...
          className={
            clicked && "hammersmithandfulham" === userLocation
              ? "clicked"
              : null
          }
          onClick={locateUser}
        ...
        <path
          ...
          className={
            clicked && "richmonduponthames" === userLocation ? "clicked" : null
          }
          onClick={locateUser}
        ...
        <path
          ...
          id="hillingdon"
          className={
            clicked && "hillingdon" === userLocation ? "clicked" : null
          }
          onClick={locateUser}
