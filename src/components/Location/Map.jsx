    ...
    <Svg>
      <g>
        <path
          ...
          className={clicked && "havering" === userLocation? "clicked" :  null }
   onClick={locateUser}
          id="havering"
          alt="Havering"
        ></path>
        ...
        <path
          ...
          id="bexley"
          className={clicked && "bexley" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          id="redbridge"
          className={clicked && "redbridge" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="1"
          id="enfield"
          className={clicked && "enfield" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="walthamforest"
          className={clicked && "walthamforest" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="1" 
          id="sutton"
          className={clicked && "sutton" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeOpacity="1"
          strokeWidth="3.5"
          id="kingstonuponthames"
          className={clicked && "kingstonuponthames" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="bromley"
          className={clicked && "bromley" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="croydon"
          className={clicked && "croydon" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeOpacity="1"
          strokeWidth="3.5"
          id="barkinganddagenham"
          className={clicked && "barkinganddagenham" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
           id="newham"
           className={clicked && "newham" === userLocation? "clicked" :  null }
           onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="greenwich"
          className={clicked && "greenwich" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="towerhamlets"
          className={clicked && "towerhamlets" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="hackney"
          className={clicked && "hackney" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="islington"
          className={clicked && "islington" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="city"
          className={clicked && "city" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="merton"
          className={clicked && "merton" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="lewisham"
          className={clicked && "lewisham" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="southwark"
          className={clicked && "southwark" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="haringey"
          className={clicked && "haringey" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="lambeth"
          className={clicked && "lambeth" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="wandsworth"
          className={clicked && "wandsworth" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="westminster"
          className={clicked && "westminster" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="camden"
          className={clicked && "camden" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="barnet"
          className={clicked && "barnet" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeOpacity="1"
          strokeWidth="3.5"
          id="kensingtonandchelsea"
          className={clicked && "kensingtonandchelsea" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeOpacity="1"
          strokeWidth="3.5"
          id="hammersmithandfulham"
          className={clicked && "hammersmithandfulham" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="brent"
          className={clicked && "brent" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="harrow"
          className={clicked && "harrow" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeOpacity="1"
          strokeWidth="3.5"
          id="richmonduponthames"
          className={clicked && "richmonduponthames" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="hounslow"
          className={clicked && "hounslow" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="hillingdon"
          className={clicked && "hillingdon" === userLocation? "clicked" :  null }
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="ealing"
          className={clicked && "ealing" === userLocation? "clicked" :  null }
          onClick={locateUser}
