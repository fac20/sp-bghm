    ...
    <Svg>
      <g>
        ...
        <path
          ...
          strokeWidth="3.5"
          id="walthamforest"
          className={"walthamforest" === userLocation ? "clicked" : null}
          onClick={locateUser}
        ...
        <path
          ...
          className={"kingstonuponthames" === userLocation ? "clicked" : null}
          onClick={locateUser}
        ...
        <path
          ...
          className={"barkinganddagenham" === userLocation ? "clicked" : null}
          onClick={locateUser}
        ...
        <path
          ...
          strokeWidth="3.5"
          id="city"
          className={"city" === userLocation ? "clicked" : null}
          onClick={locateUser}
        ...
        <path
          ...
          className={"kensingtonandchelsea" === userLocation ? "clicked" : null}
          onClick={locateUser}
        ...
        <path
          ...
          className={"hammersmithandfulham" === userLocation ? "clicked" : null}
          onClick={locateUser}
        ...
        <path
          ...
          className={"richmonduponthames" === userLocation ? "clicked" : null}
          onClick={locateUser}
